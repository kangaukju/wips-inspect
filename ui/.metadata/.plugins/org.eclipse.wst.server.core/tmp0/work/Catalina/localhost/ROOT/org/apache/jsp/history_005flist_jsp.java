 ...
 * Generated at: 2017-03-22 01:00:34 UTC
...
String currentID 
	= request.getServletPath().substring(
      ...
      out.write("\t\t<legend>\n");
      out.write("\t\t\t<img class=\"head_img\" src=\"/img/profiles.png\">\n");
      out.write("\t\t\tProfile [<span id=\"profile_legend\"></span>]\t\t\t\n");
      out.write("\t\t</legend>\t\t\n");
      out.write("\t\t\n");
      ...
      out.write("\t\tchildren: [\n");
      out.write("\t\t\t{tag:\"td\", html:\"<img class='history_check_img hidden table_img' src='/img/profiles.png' id='img_$\\{timestamp\\}'>\"},\n");
      out.write("\t\t\t{tag:\"td\", html:\"$\\{timestampString\\}\"},\n");
      out.write("\t\t\t{tag:\"td\", html:\"$\\{timestamp\\}\"},\n");
      out.write("\t\t\t{tag:\"td\", html:\"$\\{profile.configListNames\\}\"},\n");
      out.write("\t\t]\n");
      out.write("};\n");
      out.write("\n");
      out.write("function get_xml_log_table_html(data) {\n");
      out.write("\tvar html = \n");
      out.write("\t\"<tr>\"+\n");
      ...
      out.write("\t\t\"<td>\"+_default(data.addr4, \"\")+\"</td>\"+\n");
      ...
      out.write("\t\t\t\t\tvar cid = \"inspect_history_\"+i;\n");
      out.write("\t\t\t\t\tc.attr(\"id\", cid);\n");
      out.write("\t\t\t\t\tc.find(\"legend\").html(\"Config [\"+v.config.name+\"] <img src='/img/cross-button.png' class='hidable' target='\"+cid+\"'>\");\n");
      ...
      out.write("\t\t\t\t\t\t\tc.find(\".xml_log_table > tbody:last\")\n");
      out.write("\t\t\t\t\t\t\t\t.append(get_xml_log_table_html(vv.result));\n");
      out.write("\t\t\t\t\t\t});\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\tc.find(\".xml_log_table\").tablesorter({widgets: [\"zebra\"]});\n");
      out.write("\t\t\t\t\t}\n");
      out.write("\t\t\t\t\tif (1) {\n");
      ...
      out.write("\t\t\t}\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t$(\".hidable\").click(function(){\n");
      out.write("\t\t\t\tvar $target = $(\"#\"+$(this).attr(\"target\"));\n");
      out.write("\t\t\t\t$target.hide(\"slow\", function() { $target.remove(); });\n");
      out.write("\t\t\t});\n");
      out.write("\t\t\t\n");
