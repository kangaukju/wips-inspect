 ...
 * Generated at: 2017-03-20 07:50:46 UTC
...
public final class history_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/header.jsp", Long.valueOf(1489986672000L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t<img class=\"head_link_img home_link_profile_list\" src=\"/img/binary-tree.png\">\n");
      out.write("\t\t\t<img class=\"head_link_img home_link_config_list\"  src=\"/img/EditDocument.svg\">\n");
 ...
 boolean debug = HttpGet.sessionBoolean(request, "debug", true); 
      ...
      out.write("\t\t<legend>\n");
      out.write("\t\t\t<img class=\"head_img\" src=\"/img/list_banner.svg\">\n");
      out.write("\t\t\t<span id=\"profile_legend\"></span>\n");
      out.write("\t\t</legend>\n");
      out.write("\t\t\n");
      out.write("\t\t<table id=\"history_list_table\" class=\"tablesorter\">\n");
      out.write("\t\t\t<thead>\n");
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<th width=\"20px;\"></th>\n");
      out.write("\t\t\t\t\t<th>timestamp</th>\n");
      out.write("\t\t\t\t\t<th>configs</th>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t</thead>\n");
      ...
      out.write("\t</fieldset>\n");
      out.write("\t\n");
      out.write("\t<div id=\"inspect_history_div\"></div>\n");
      out.write("\t\n");
      out.write("\t<fieldset id=\"sample_inspect_history\" class=\"main_fieldset hidden\">\n");
      ...
      out.write("\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t<img class=\"icon_img wireshark_img\"  align=\"left\" src=\"/img/wireshark.png\" filepath=\"\"/>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</td>\n");
      out.write("\t\t\t</tr>\n");
      out.write("\t\t\t<tr>\n");
      out.write("\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t<table class=\"tablesorter xml_log_table\">\n");
      out.write("\t\t\t\t\t\t<thead>\n");
      out.write("\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t<th>xid</th>\n");
      ...
      out.write("';\n");
      out.write("\n");
      out.write("var history_list_table_xlat = {\n");
      out.write("\t\ttag: \"tr\",\n");
      out.write("\t\tprofile_id: '$\\{profileId\\}',\n");
      out.write("\t\ttimestamp: '$\\{timestamp\\}',\n");
      out.write("\t\tclass:\"pointer\",\n");
      out.write("\t\tchildren: [\n");
      out.write("\t\t\t{tag:\"td\", html:\"<img class='history_check_img hidden table_img' src='/img/profile.svg' id='img_$\\{timestamp\\}'>\"},\n");
      out.write("\t\t\t{tag:\"td\", html:\"$\\{timestamp\\}\"},\n");
      out.write("\t\t\t{tag:\"td\", html:\"$\\{profile.configListNames\\}\"},\n");
      out.write("\t\t]\n");
      out.write("};\n");
      out.write("\n");
      out.write("var xml_log_table_xlat = {\n");
      out.write("\t\ttag: \"tr\",\n");
      out.write("\t\tchildren: [\n");
      out.write("\t\t\t{tag:\"td\", html:\"$\\{result.xid\\}\"},\n");
      out.write("\t\t\t{tag:\"td\", html:\"$\\{result.elapsed\\}\"},\n");
      out.write("\t\t\t{tag:\"td\", html:\"$\\{result.pwr\\}\"},\n");
      out.write("\t\t\t{tag:\"td\", html:get_framesubtype_string(\"$\\{result.type\\}\", \"$\\{result.subtype\\}\")},\n");
      out.write("\t\t\t{tag:\"td\", html:\"$\\{result.elapsed\\}\"},\n");
      out.write("\t\t\t{tag:\"td\", html:\"$\\{result.addr1\\}\"},\n");
      out.write("\t\t\t{tag:\"td\", html:\"$\\{result.addr2\\}\"},\n");
      out.write("\t\t\t{tag:\"td\", html:\"$\\{result.addr3\\}\"},\n");
      out.write("\t\t\t{tag:\"td\", html:\"$\\{result.addr4\\}\"},\n");
      out.write("\t\t\t{tag:\"td\", html:\"$\\{result.seq\\}\"},\n");
      out.write("\t\t]\n");
      out.write("};\n");
      out.write("\n");
      out.write("function load_inspect_history_list(profile_id, timestamp) {\n");
      out.write("\tjQuery.ajax({\n");
      out.write("\t\turl: \"/get_history.jsp\",\n");
      out.write("\t\tdata: {\n");
      ...
      out.write("\t\t\t$(\"#inspect_history_div\").empty();\n");
      out.write("\t\t},\n");
      out.write("\t\tdataType: \"json\",\n");
      out.write("\t\tsuccess: function(result) {\n");
      out.write("\t\t\tif (result.good == false) {\n");
      out.write("\t\t\t\tpop(\"Error loading for inspect history list: \"+result.cause);\n");
      out.write("\t\t\t\treturn;\n");
      out.write("\t\t\t}\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t//console.log(result);\n");
      out.write("\t\t\tif (_defined_(result.inspectXmlLogList)) {\t\t\t\t\n");
      out.write("\t\t\t\t$.each(result.inspectXmlLogList, function(i, v) {\n");
      out.write("\t\t\t\t\tvar xml_log_json = jQuery.parseJSON(v.xmlLog).aircaptures.aircapture;\n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\tvar c = $(\"#sample_inspect_history\").clone();\n");
      out.write("\t\t\t\t\tc.attr(\"id\", \"inspect_history_\"+i);\n");
      out.write("\t\t\t\t\tc.find(\"legend\").html(v.config.name);\n");
      out.write("\t\t\t\t\tc.removeClass(\"hidden\");\n");
      out.write("\t\t\t\t\tc.appendTo($(\"#inspect_history_div\"));\n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\tif (1) {\n");
      out.write("\t\t\t\t\t\t// build xml_log_table\n");
      out.write("\t\t\t\t\t\tc.find(\".xml_log_table > tbody\").html(\n");
      out.write("\t\t\t\t\t\t\t\tjson2html.transform(xml_log_json, xml_log_table_xlat)\n");
      out.write("\t\t\t\t\t\t);\n");
      out.write("\t\t\t\t\t\tc.find(\".xml_log_table\").tablesorter();\n");
      out.write("\t\t\t\t\t}\n");
      out.write("\t\t\t\t\tif (1) {\n");
      out.write("\t\t\t\t\t\t// bind pcap file for wireshark\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t$.each(result.inspectPcapLogList, function(ii, vv) {\n");
      out.write("\t\t\t\t\t\t\tif (vv.config.id == v.config.id) {\n");
      out.write("\t\t\t\t\t\t\t\tc.find(\".wireshark_img\").attr(\"filepath\", vv.PcapFilepath);\n");
      out.write("\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t});\n");
      out.write("\t\t\t\t\t}\n");
      out.write("\t\t\t\t\tif (1) {\n");
      out.write("\t\t\t\t\t\t// set inspect chart id\n");
      out.write("\t\t\t\t\t\tc.find(\".inspect_chart\").attr(\"id\", \"inspect_chart_\"+v.config.id);\n");
      out.write("\t\t\t\t\t\tvar items = new Array();\n");
      out.write("\t\t\t\t\t\tvar max_sec = parseInt(result.runTimer) + 2;\n");
      out.write("\t\t\t\t\t\tvar inspect_config_keys = {};\n");
      out.write("\t\t\t\t\t\tvar inspect_charts = {};\n");
      out.write("\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t// capture config keys\n");
      out.write("\t\t\t\t\t\tif (_defined_(v.config.captureXmlAirConfList)) {\n");
      out.write("\t\t\t\t\t\t\t$.each(v.config.captureXmlAirConfList, function(ii, vv) {\n");
      out.write("\t\t\t\t\t\t\t\tinspect_config_keys[vv.key] = vv.desc;\n");
      out.write("\t\t\t\t\t\t\t});\n");
      out.write("\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t// shooter config keys\n");
      out.write("\t\t\t\t\t\tif (_defined_(v.config.shooterXmlAirConfList)) {\n");
      out.write("\t\t\t\t\t\t\t$.each(v.config.shooterXmlAirConfList, function(ii, vv) {\n");
      out.write("\t\t\t\t\t\t\t\tinspect_config_keys[vv.key] = vv.desc;\n");
      out.write("\t\t\t\t\t\t\t});\n");
      out.write("\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t// push header data\n");
      out.write("\t\t\t\t\t\t$.each(inspect_config_keys, function(ii, vv) {\n");
      out.write("\t\t\t\t\t\t\titems.push(vv);\n");
      out.write("\t\t\t\t\t\t});\n");
      out.write("\t\t\t\t\t\t// create inspect chart\n");
      out.write("\t\t\t\t\t\tinspect_charts = inspectChart.generate(\n");
      out.write("\t\t\t\t\t\t\t\"inspect_chart_\"+v.config.id, {\n");
      out.write("\t\t\t\t\t\t\t\titems: items,\n");
      out.write("\t\t\t\t\t\t\t\tmax_sec: max_sec,\n");
      out.write("\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t);\n");
      out.write("\t\t\t\t\t\t$.each(xml_log_json, function(ii, vv) {\n");
      out.write("\t\t\t\t\t\t\tvar item = inspect_config_keys[vv.result.key];\n");
      out.write("\t\t\t\t\t\t\tvar x = vv.result.elapsed;\n");
      out.write("\t\t\t\t\t\t\tvar y = vv.result.pwr;\n");
      out.write("\t\t\t\t\t\t\tif (_defined_(item)) {\n");
      out.write("\t\t\t\t\t\t\t\tinspect_charts.push(item, x, y, false);\n");
      out.write("\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t});\n");
      out.write("\t\t\t\t\t\t// draw chart\n");
      out.write("\t\t\t\t\t\t$.each(inspect_config_keys, function(ii, vv) {\n");
      out.write("\t\t\t\t\t\t\tconsole.log(\"draw = \"+vv);\n");
      out.write("\t\t\t\t\t\t\tinspect_charts.refresh(vv);\n");
      out.write("\t\t\t\t\t\t});\n");
      out.write("\t\t\t\t\t}\n");
      out.write("\t\t\t\t});\n");
      out.write("\t\t\t}\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t$(\".wireshark_img\").click(function(e) {\n");
      out.write("\t\t\t\tvar filepath = $(this).attr(\"filepath\");\n");
      out.write("\t\t\t\tjQuery.ajax({\n");
      out.write("\t\t\t\t\turl: \"/run_wireshart.jsp\",\n");
      out.write("\t\t\t\t\tdata: {filepath: filepath},\n");
      out.write("\t\t\t\t\tcache: false,\n");
      out.write("\t\t\t\t\tdataType: \"json\",\n");
      out.write("\t\t\t\t\tsuccess: function(result) {\n");
      out.write("\t\t\t\t\t\tif (result.good == false) {\n");
      out.write("\t\t\t\t\t\t\tpop(\"Error run wireshark: \"+result.cause);\n");
      out.write("\t\t\t\t\t\t\treturn;\n");
      out.write("\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t},\n");
      out.write("\t\t\t\t\terror: function(e) {\n");
      out.write("\t\t\t\t\t\t//ajax_err_handle(e);\n");
      out.write("\t\t\t\t\t\tpop(\"Error run wireshark.\\nplease retry...\");\n");
      out.write("\t\t\t\t\t}\n");
      out.write("\t\t\t\t});\n");
      out.write("\t\t\t});\n");
      out.write("\t\t},\n");
      out.write("\t\terror: function(e) {\n");
      out.write("\t\t\t//ajax_err_handle(e);\n");
      out.write("\t\t\tpop(\"Error loading for inspect history.\\nplease retry...\");\n");
      out.write("\t\t}\n");
      out.write("\t});\n");
      out.write("}\n");
      out.write("\n");
      out.write("function load_history_list() {\n");
      out.write("\tjQuery.ajax({\n");
      out.write("\t\turl: \"/get_history.jsp\",\n");
      out.write("\t\tdata: {profile_id: profile_id},\n");
      out.write("\t\tcache: false,\n");
      out.write("\t\tbeforeSend: function() {\n");
      out.write("\t\t\t$(\"#history_list_table > tbody\").empty();\n");
      out.write("\t\t},\n");
      out.write("\t\tdataType: \"json\",\n");
      out.write("\t\tsuccess: function(result) {\n");
      out.write("\t\t\tif (result.good == false) {\n");
      out.write("\t\t\t\tpop(\"Error loading for history list: \"+result.cause);\n");
      out.write("\t\t\t\treturn;\n");
      out.write("\t\t\t}\n");
      out.write("\t\t\t$(\"#history_list_table > tbody\").html(\n");
      out.write("\t\t\t\tjson2html.transform(result, history_list_table_xlat)\n");
      out.write("\t\t\t);\n");
      out.write("\t\t\t$(\"#history_list_table\").tablesorter({\n");
      out.write("\t\t\t\theaders: {\n");
      ...
      out.write("\t\t\t\n");
      out.write("\t\t\t$(\"#history_list_table > tbody > tr\").click(function(e) {\n");
      out.write("\t\t\t\t$(\"#history_list_table > tbody > tr\").removeClass('selected');\n");
      out.write("\t\t\t\t$(this).toggleClass('selected');\n");
      out.write("\t\t\t\t$(\".history_check_img\").addClass('hidden');\n");
      out.write("\t\t\t\t$(\"#img_\"+$(this).attr(\"id\")).toggleClass('hidden');\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\tload_inspect_history_list($(this).attr(\"profile_id\"), $(this).attr(\"timestamp\"));\n");
      out.write("\t\t\t});\n");
      out.write("\t\t\t\n");
      out.write("\t\t\tload_ok();\n");
      out.write("\t\t},\n");
      ...
      out.write("\t\t\tload_ok();\n");
      out.write("\t\t\t//ajax_err_handle(e);\n");
      out.write("\t\t\tpop(\"Error loading for history.\\nplease retry...\");\n");
      out.write("\t\t}\n");
      out.write("\t});\n");
      out.write("}\n");
      out.write("\n");
      out.write("function load_profile(profile_id) {\n");
      out.write("\tjQuery.ajax({\n");
      ...
      out.write("\t\t\t\treturn;\n");
      out.write("\t\t\t}\n");
      out.write("\t\t\t$(\"#profile_legend\").html(result.name);\n");
      out.write("\t\t},\n");
      out.write("\t\terror: function(e) {\n");
      out.write("\t\t\t//ajax_err_handle(e);\n");
      out.write("\t\t\tpop(\"Error delete profile.\\nplease retry...\");\n");
      out.write("\t\t}\n");
      out.write("\t});\n");
      out.write("}\n");
      out.write("\n");
      out.write("$(document).ready(function() {\n");
      out.write("\tload_profile(profile_id);\n");
      out.write("\tload_history_list();\n");
      out.write("});\n");
      out.write("</script>\n");
      out.write("\n");
      out.write("<script type=\"text/javascript\">\n");
