 ...
 * Generated at: 2017-02-21 07:49:37 UTC
...
public final class get_005fconfig_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	try {
		if (id != null) {
			response.getWriter().print(new Gson().toJson(Config.getById(id)));
		} else if (name != null) {
			response.getWriter().print(new Gson().toJson(Config.getByName(name)));	
		} else {
			response.getWriter().print(new Gson().toJson(Config.getAll()));	
		}
	} catch (Exception e) {
		e.printStackTrace();
