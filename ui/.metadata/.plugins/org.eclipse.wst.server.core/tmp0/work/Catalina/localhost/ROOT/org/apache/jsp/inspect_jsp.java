 ...
 * Generated at: 2017-03-20 08:49:29 UTC
...
public final class inspect_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 boolean debug = HttpGet.sessionBoolean(request, "debug", true); 
      ...
      out.write("\t\t\n");
      out.write("\t\t<div>\n");
      out.write("\t\t\t<img class=\"action_img\" src=\"/img/clock.svg\">\n");
      ...
      out.write("\t\t\t</select>\n");
      out.write("\t\t\t<img class=\"action_img\" src=\"/img/play4.svg\" id=\"inspect_run_img\">\n");
      out.write("\t\t\t<img class=\"action_img\" src=\"/img/save.png\" id=\"inspect_save_img\">\n");
      out.write("\t\t</div>\n");
      out.write("\t\t\n");
      ...
      out.write("\t\n");
      out.write("\t<fieldset class=\"main_fieldset\">\n");
      out.write("\t\t<legend id=\"inspect_results_legend\">\n");
      out.write("\t\t\t<img class=\"head_img\" src=\"/img/inspect.png\">\n");
      out.write("\t\t\tInspect Results\t\t\t\n");
      out.write("\t\t</legend>\n");
      ...
      out.write("\t</fieldset>\n");
      out.write("\t\n");
      out.write("\t<form id=\"hidden_form\" method=\"post\">\n");
      out.write("\t</form>\n");
      out.write("</body>\n");
      out.write("\n");
      out.write("<script type=\"text/javascript\">\n");
      ...
      out.write("\t\tchildren: [\n");
      out.write("\t\t\t{tag:\"td\", html:\"<img class='profile_check_img hidden table_img' src='/img/profile.svg' id='img_$\\{id\\}'>\"},\n");
      out.write("\t\t\t{tag:\"td\", html:\"$\\{name\\}\"},\n");
      out.write("\t\t\t{tag:\"td\", html:\"$\\{configListNames\\}\"},\n");
      out.write("\t\t\t{tag:\"td\", html:\"$\\{updated\\}\"},\n");
      out.write("\t\t\t{tag:\"td\", html:\"<img class='profile_log_img table_img' src='/img/Graph-Magnifier.svg' id='$\\{id\\}'>\"},\n");
      out.write("\t\t]\n");
      out.write("};\n");
      out.write("\n");
      ...
      out.write("\t\tclass:\"pointer\",\n");
      out.write("\t\tchildren: [\n");
      out.write("\t\t\t{tag:\"td\", html:\"<img class='config_check_img table_img' src='/img/menu.svg' id='img_$\\{id\\}'>\"},\n");
      out.write("\t\t\t{tag:\"td\", html:\"$\\{name\\}\"},\n");
      ...
      out.write("\t\t\t\tc.find(\".inspect_chart\").attr(\"config_id\", v.id);\n");
      ...
      out.write("\t\tsuccess: function(result) {\n");
      out.write("\t\t\tif (result.good == false) {\n");
      out.write("\t\t\t\tpop(\"Error loading for profile list: \"+result.cause);\n");
      out.write("\t\t\t\treturn;\n");
      out.write("\t\t\t}\n");
      ...
      out.write("\t\t\t});\n");
      out.write("\t\t\t$(\".profile_log_img\").click(function() {\n");
      out.write("\t\t\t\tgogo(\"history_list.jsp?profile_id=\"+$(this).attr(\"id\"));\n");
      out.write("\t\t\t});\n");
      out.write("\t\t},\n");
      out.write("\t\terror: function(e) {\n");
      out.write("\t\t\t//ajax_err_handle(e);\n");
      ...
      out.write("\t});\n");
      out.write("\t\n");
      out.write("\t$(\"#inspect_save_img\").click(function() {\n");
      out.write("\t\t$.post(\"save_inspect.jsp\", $(\"#hidden_form\").serialize())\n");
      ...
      out.write("\t\t\t\t}\n");
      out.write("\t\t\t\telse {\n");
      out.write("\t\t\t\t\tpop(\"success saved inspect result\", {\n");
      ...
      out.write("\t\t\t\tif (result.good == false) {\n");
      out.write("\t\t\t\t\tpop(\"Error running inspect: \"+result.cause);\n");
      out.write("\t\t\t\t\t$img.attr(\"src\", \"/img/play4.svg\");\n");
      ...
      out.write("\t\t\t\t$img.attr(\"src\", \"/img/play4.svg\");\n");
      out.write("\t\t\t\tpop(\"Error running inspect: \"+msg);\n");
      out.write("\t\t\t\tws_raise_error = true;\n");
      out.write("\t\t\t}\n");
      out.write("\t\t\t/* onerror */\n");
      out.write("\t\t\tws.onclose = function() {\n");
      out.write("\t\t\t\t$(\"#hidden_form\").empty();\n");
      out.write("\t\t\t\t/*\n");
      out.write("\t\t\t\t$(\".inspect_chart\").each(function(i) {\n");
      out.write("\t\t\t\t\tvar config_id = $(this).attr(\"config_id\");\n");
      out.write("\t\t\t\t\tif (_defined_(config_id)) {\n");
      out.write("\t\t\t\t\t\thtml2canvas($(this).find(\"svg\"), {\n");
      out.write("\t\t\t\t\t\t\tonrendered: function(canvas) {\n");
      out.write("\t\t\t\t\t\t\t\tvar png = canvas.toDataURL(\"image/png\", 1.0);\n");
      out.write("\t\t\t\t\t\t\t\t$(\"<input></input>\").attr({\n");
      out.write("\t\t\t\t\t\t\t\t\ttype: \"hidden\",\n");
      out.write("\t\t\t\t\t\t\t\t\tname: \"chart_img\",\n");
      out.write("\t\t\t\t\t\t\t\t\tvalue: png,\n");
      out.write("\t\t\t\t\t\t\t\t}).appendTo($(\"#hidden_form\"));\n");
      out.write("\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t$(\"<input></input>\").attr({\n");
      out.write("\t\t\t\t\t\t\t\t\ttype: \"hidden\",\n");
      out.write("\t\t\t\t\t\t\t\t\tname: \"config_id\",\n");
      out.write("\t\t\t\t\t\t\t\t\tvalue: config_id,\n");
      out.write("\t\t\t\t\t\t\t\t}).appendTo($(\"#hidden_form\"));\n");
      out.write("\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t});\n");
      out.write("\t\t\t\t\t}\n");
      ...
      out.write("\t\t\t\t$(\"<input></input>\").attr({\n");
      out.write("\t\t\t\t\ttype: \"hidden\",\n");
      out.write("\t\t\t\t\tname: \"profile_id\",\n");
      out.write("\t\t\t\t\tvalue: $(\"#profile_list_table > tbody .selected\").attr(\"id\"),\n");
      out.write("\t\t\t\t}).appendTo($(\"#hidden_form\"));\n");
      out.write("\t\t\t\t*/\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t$img.attr(\"src\", \"/img/play4.svg\");\n");
