...
<body>
	<fieldset class="main_fieldset">
		...
		<div>
			<img class="action_img" src="/img/refresh-outline.svg">
			...
			<img class="table_img" src="/img/apps.svg" style="padding-left: 10px;">
			<select id="channel" style="width: 120px;">
			</select>
			<img class="action_img" src="/img/play4.svg" id="wifi_search_img">
		</div>
